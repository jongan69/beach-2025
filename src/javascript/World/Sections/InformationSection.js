...
export default class InformationSection
{
    ...
    setStatic()
    {
        ...
        const baseSceneClone = this.resources.items.informationStaticBase.scene.clone()
        const collisionSceneClone = this.resources.items.informationStaticCollision.scene.clone()
