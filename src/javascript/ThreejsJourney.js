...
//             'color: #705df2;'
//         )
        console.log('%cGRAD TRACK', 'color: #32ffce; font-size: 16px; font-weight: bold');
        console.log('%cAI-powered degree planning that aligns academic decisions with career outcomes, cost efficiency, and instructor quality-instantly.', 'color: #32ffce');
        console.log('%cExplore the 3D world to discover more!', 'color: #32ffce');
    }
